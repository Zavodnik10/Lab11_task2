...
class LinkedBST(AbstractCollection):
        ...
        def height1(top, i):
            ...
            if top is None:
                ...
                if top.right is not None:
                    return height1(top.right, i)
                elif top.left is not None:
                    return height1(top.left, i)
            return i
        return height1(self._root, 0)
    ...
    def rebalance(self):
        ...
        self._root = build_balanced_tree(sorted_list)
    ...
    def demo_bst(self, path):
        ...
        return list_search_time, bst_search_time
a = LinkedBST()
a.add(1)
print(a.demo_bst('words (1).txt'))